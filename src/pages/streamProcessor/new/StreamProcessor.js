    ...
    <div className="wrapper">
      ...
      <div className="marginTop-20 streamProcessorCardContainer">
        <div className="new-item__body">
          <Step isInbound={true} />
          <SchemaBlock togglePolio={togglePolio} polio={polio} />
          {isAddedSteps &&
            addedSteps.map((item, i) => {
              return (
                <div className="newStep">
                  <Step isInbound={false} item={item} />
                  <SchemaBlock togglePolio={togglePolio} polio={polio} />
                </div>
              );
            })}
      ...
      <div onClick={() => toggleModal()}>
        <Button text={"+ Add New Step"} color={"white"} />
      </div>
